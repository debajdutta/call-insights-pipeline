 ...
 * concrete event class - same rationale as transcription-service's KafkaConsumerConfig.
 */
@Configuration
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, CallTranscriptGeneratedEvent> transcriptGeneratedConsumerFactory() {
        return consumerFactory("summary-service-transcript-generated", CallTranscriptGeneratedEvent.class);
    }
    ...
    public ConsumerFactory<String, ArtifactRegenerationRequestedEvent> regenerationRequestedConsumerFactory() {
        return consumerFactory("summary-service-regeneration-requested", ArtifactRegenerationRequestedEvent.class);
    }
